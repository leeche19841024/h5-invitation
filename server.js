...
// 确保registrations.json和users.json文件存在
ensureFileExists(registrationsFilePath, JSON.stringify([], null, 2));
ensureFileExists(usersFilePath, JSON.stringify([{"username": "admin", "password": "admin123"}], null, 2)); // 初始用户
